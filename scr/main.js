...
for (x =1; x <= tokenNr; x++){
    ...
    randomPosition_T = getRandomInt(10, 25);
    randomPosition_WH = getRandomInt(-20, 40);
...
var randomDelay;
var startScale = 0;
        scale = getRandomArbitrary(0.7,1.1);
    for (x =1; x <= tokenNr; x++){
        token_name = "token" + x; 
        ...
        startScale = getRandomArbitrary(0.7,1.1);
        ...
        set_opacity = TweenMax.to("#" + token_name, 2, {scale:1.1, opacity: 1, repeat:0});
...
var myVar = setInterval(zigzag, 10000);
var scale = 0;
var scaleSpeed = 0;
var randomDelay;
function zigzag() {
    ...
    for (x =1; x <= tokenNr; x++){
        ...
        randomDelay = getRandomArbitrary(0.5,5);
        
        scale = getRandomArbitrary(0.7,1.2);
        scaleSpeed = getRandomInt(15,25);

        up_down_speed = getRandomInt(6,12);
        up_down_anim = getRandomInt(10,40);
        if (anim_token_positon_T >=110 ) {up_down_anim = getRandomInt(-20,20);}

        TweenMax.to("#" + token_name, up_down_speed, {y: up_down_anim, z:0.1, force3D: true, rotationZ: 0.01, ease: Power3.easeInOut, delay:randomDelay });
        TweenMax.to("#" + token_name, scaleSpeed, {scale:scale, ease: Power3.easeInOut, delay:randomDelay, z:0.1, force3D: true, rotationZ: 0.01});
...
// var arrayOfPostion = ["-300", "-1400", "-1800", "-2200", "", "-3000", "-3400"]
// var pos_index = 0;
// var myVar2 = setInterval(left_right_animation, 20000);
// function left_right_animation() {
...
//         randomDelay = getRandomArbitrary(0.5,21);
//         pos_index = getRandomInt(0 ,5);

//         // left_right_speed = getRandomInt(4);
//         left_right_speed = 3;
//         left_right_anim = getRandomInt(-5,5);

//         if (getRandomInt(1, 3)==2) {
//             TweenMax.to("#token" + x , left_right_speed, {x: "+=" + left_right_anim,  delay:randomDelay,ease: Power3.easeIn, ease: Power3.easeOut, onComplete: resetmovement.bind("#token" + x, x, "Hello")});
//         }
//     }

// }

// function resetmovement(z,msg){
//     TweenMax.to("#token" + z, speed, {x: -1850, repeat:-1});
//     TweenMax.killTweensOf("#token" + z);
// }
